...
check_install.py
----------------
Verifies AttentiveFP (DeepPurpose) is installed correctly.
...
# ── Check 2: AttentiveFP encoder loads ─────────────────────────────────────────

def check_encoder():
    from DeepPurpose import utils
    print("  Loading DGL_AttentiveFP encoder...")
...
if __name__ == "__main__":
    print("=" * 50)
    print("  AttentiveFP Installation Check")
    print("=" * 50)

    results = [
        check("1. Imports",                check_imports),
        check("2. AttentiveFP encoder",    check_encoder),
